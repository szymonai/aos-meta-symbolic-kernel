...
- [ ] No full AOS Core, private policy semantics, adapter protocol, validation
      stack, specialist-system code, calibration data, private proof artifacts,
      private benchmarks, optimization code, or commercial SDK/API material is
      included.
