...
- private manifests, private certificates, or generated claim bundles
- optimization code or private benchmarks
- deployment secrets, local paths, private logs, customer data, or partner data
- material that may require patent review before public disclosure
